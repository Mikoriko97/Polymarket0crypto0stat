        ...
        <div className="neumorphic-elevated p-8 space-y-6">
          <div className="flex items-start justify-between">
            <div className="space-y-3">
              ...
              {marketUrl ? (
                <Link href={marketUrl} target="_blank" rel="noopener noreferrer" className="text-primary hover:underline inline-flex items-center gap-2">
                  View on Polymarket
          ...
          <div className="neumorphic-elevated p-8 space-y-6">
            <MarketAnalysis marketQuestion={market.question ?? ""} />
          </div>
        </div>
